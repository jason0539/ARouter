...
public class LogisticsCenter {
    ...
    public static final void loadIntoRoutes(IRouteGroup iRouteGroup) {
        if (iRouteGroup != null) {
            iRouteGroup.loadInto(Warehouse.routes);
        }
    }

    public static final void loadIntoInterceptors(IInterceptorGroup iInterceptorGroup){
        if (iInterceptorGroup != null) {
            iInterceptorGroup.loadInto(Warehouse.interceptorsIndex);
        }
    }

    public static final void loadIntoProviders(IProviderGroup iProviderGroup){
